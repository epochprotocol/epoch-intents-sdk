export default `[
  ...
  {
    "type": "function",
    "name": "executeEscrowTransfer",
    "inputs": [
      { "name": "user", "type": "address", "internalType": "address" },
      { "name": "intentIndex", "type": "uint256", "internalType": "uint256" }
    ],
  ...
  { "type": "error", "name": "BalanceDecreasedAfterExecution", "inputs": [] },
  { "type": "error", "name": "DeadlinePassed", "inputs": [] },
  { "type": "error", "name": "NotAllowedToExecuteIntent", "inputs": [] },
  { "type": "error", "name": "NotAllowedToUseToken", "inputs": [] },
  {
    "type": "error",
    "name": "NotInitialized",
    "inputs": [
