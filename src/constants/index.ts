...
export const INTENT_REGISTRY_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x299Ea355dBeDF225b3a88D67827a0a04dF943749",
...
export const EPOCH_MODULE_SAFE_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x1b4a3398102d42CA600Cb7e3f40a5495B4954071",
...
export const EPOCH_SAFE_INIT_SETUP: { [key: number]: string } = {
  ...
  42101: "0xf460890181cB9C76EE404edE779555c9fEefB10e",
...
export const SAFE_INIT_SETUP_FORWARDER: { [key: number]: string } = {
  ...
  42101: "0x8c7192D248361844DBDdDa5dE58DF591996C44CB",
...
export const SAFE_WEBAUTHN_SHARED_SIGNER: { [key: number]: string } = {
  ...
  42101: "0x049b3EA3f45460dec04438312e70876f9325a737",
};
...
export const SAFE_WEBAUTHN_SIGNER_FACTORY: { [key: number]: string } = {
  ...
  42101: "0xE66584AFFD075E9224d3B0f36978ec0263cEd6FD",
};
...
export const FCLP256Verifier: { [key: number]: string } = {
  ...
  42101: "0xFB5D9DAddC16Bd61566c82Bf3F0659ce2B538bEE",
};
...
export const SAFE_PROXY_FACTORY_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x6F0035ed7325d0DAaC2eB12562422Ae53faa682C",
};
//todo: update for testnets
export const SAFE_SINGLETON_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x5FdB4DaE6733008c82652D4e1B4a8c02dA3F5175",
};
...
export const SAFE_7702_SINGLETON_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x18F2d1EB128e64fE5EDcCa6A0Fa7702Aa44cf664",
};
...
export const SAFE_7579_MODULE_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x5f73D1792f81Ee2356f99764904Cb03956F577d0",
};
//todo: update for testnets
export const SAFE_7579_REGISTRY_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x6F1aBD911DBec98EEd1DfA470Ee98b61D3131A55",
};
//todo: update for testnets
export const EIP7702_SAFE_PROXY_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0xc8490cDee50174A00105598AD615e2d00f0Cfb10",
};
...
export const METAMASK_EXEC_MANAGER: { [key: number]: string } = {
  ...
  42101: "0xC913903b10f8Aa3bEf3e368EbDAeb13D73603524",
};
...
export const EPOCH_ESCROW_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0xA88Ea7EB5f687d05e20b7232d698864A7c17e20C",
};
...
export const SAFE_MULTISEND_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x328AB3a53287503DF0EFED81928a2b45b3205B2A",
};
...
export const SAFE_MULTISEND_CALL_ONLY_ADDRESS: { [key: number]: string } = {
  ...
  42101: "0x944b129a384265D916fbEA3440CD2caA4925145c",
};
